...
import TextInputBlank from './TextInputBlank';
  ...
  userData = {
        ...
        onSuccess: (result) => {
          ...
          // } 
            ...
            cognitoUser.getUserAttributes((err, result) => {
              ...
              this.showLoader(setTimeout(function(){ navigation.navigate('App'); }, 10000));
    ...
    number, uppercase, lowercase and spl character)"  
      ...
      createUserInAmazonCognito() {
        ...
        var attributePhoneNo = new AmazonCognitoIdentity.CognitoUserAttribute({
          Name: 'Phone no',
          Value: this.state.phoneno
        });
        ...
        var attributeConfirmPassword = new AmazonCognitoIdentity.CognitoUserAttribute({
